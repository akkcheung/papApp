        ...
        $(document).ready(function () {
            ...
            $("#dataTable").jqxDataTable(
            {
                ...
                columns: [
                  ...
                  { text: 'ID Num.', dataField: 'identity', width: 200 },
                  { text: 'Tel.', dataField: 'tel', width: 200 },
                  { text: 'Occupation', dataField: 'occupation', width: 100 },
                  { text: 'Salary', dataField: 'salary' , width: 100}
              	],
	            ready: function () {
	            	  $("#id").jqxInput({disabled: true, width: 150, height: 30 });
	            	  $("#source").jqxInput({width: 150, height: 30 });
	            	  $("#name").jqxInput({width: 150, height: 30 });
	            	  $("#identity").jqxInput({width: 150, height: 30 });
	            	  $("#tel").jqxInput({width: 150, height: 30 });
	            	  $("#occupation").jqxInput({width: 150, height: 30 });
	            	  $("#salary").jqxInput({width: 150, height: 30 });
